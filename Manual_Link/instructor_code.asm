; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24215.1 
	...
	TITLE	C:\Users\Joseph\Documents\Visual Studio 2015\Projects\Manual_Link\instructor_code.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
$SG4577	DB	'There is a disparity in the dimension of the parallel ar'
	DB	'rays!', 0aH, 'EXITING...', 0aH, 00H
	ORG $+2
$SG4578	DB	'********', 0aH, 00H
	ORG $+2
$SG4579	DB	'TEST #%d', 0aH, 00H
	ORG $+2
$SG4580	DB	'********', 0aH, 00H
	ORG $+2
$SG4581	DB	09H, 'Original Array:', 09H, 00H
	ORG $+2
$SG4582	DB	09H, 'Actual Length:', 09H, '%d', 0aH, 00H
$SG4583	DB	09H, 'Testing Length:', 09H, '%d', 0aH, 00H
	ORG $+3
$SG4584	DB	09H, 'Return Value:', 09H, 00H
$SG4587	DB	'PASS', 0aH, 00H
	ORG $+2
$SG4588	DB	'FAIL', 0aH, 00H
	ORG $+2
$SG4589	DB	09H, 'Output Array:', 09H, 00H
$SG4590	DB	09H, 'Expected Array:', 09H, 00H
	ORG $+2
$SG4591	DB	09H, 'Sort Test:', 09H, 00H
	ORG $+3
$SG4594	DB	'PASS', 0aH, 00H
	ORG $+2
$SG4595	DB	'FAIL', 0aH, 00H
	ORG $+2
$SG4596	DB	'******************', 0aH, 00H
$SG4597	DB	'%d tests were run.', 0aH, 00H
$SG4598	DB	'%d tests passed.', 0aH, 00H
	ORG $+2
$SG4599	DB	'******************', 0aH, 00H
$SG4600	DB	0aH, 'Press any key...', 0aH, 00H
	ORG $+1
$SG4615	DB	'%d ', 00H
$SG4616	DB	0aH, 00H
_DATA	ENDS
...
_main	PROC
; File c:\users\joseph\documents\visual studio 2015\projects\manual_link\instructor_code.c
; Line 18
	push	ebp
	mov	ebp, esp
...
$LN8@sort_int_a:
; Line 269
	cmp	DWORD PTR _arrayLen$[ebp], 2
	jge	SHORT $LN10@sort_int_a
; Line 271
	mov	eax, -2					; fffffffeH
	jmp	$LN1@sort_int_a
; Line 272
...
$LN4@sort_int_a:
	...
	cmp	ecx, DWORD PTR _arrayLen$[ebp]
	jge	$LN3@sort_int_a
; Line 277
	mov	edx, DWORD PTR _arrayLen$[ebp]
	sub	edx, 1
...
; Line 280
	...
	mov	edx, DWORD PTR [eax+edx*4]
	cmp	edx, DWORD PTR [esi+ecx*4]
	jle	SHORT $LN12@sort_int_a
; Line 282
	mov	eax, DWORD PTR _i$[ebp]
	mov	ecx, DWORD PTR _intArray$[ebp]
	mov	edx, DWORD PTR _j$[ebp]
	mov	esi, DWORD PTR _intArray$[ebp]
	mov	eax, DWORD PTR [ecx+eax*4]
	xor	eax, DWORD PTR [esi+edx*4]
	mov	ecx, DWORD PTR _i$[ebp]
